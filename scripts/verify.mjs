...
if(!fs.readFileSync(path.join(root,'resource.css'),'utf8').includes('@page{size:A4'))throw new Error('A4 print CSS missing');if(!fs.existsSync(path.join(root,'health.txt')))throw new Error('Production health marker missing');
